...
class Exercise
{
	...
	public function getQuiz($id)
    {
		...
		$result = Database::fetch_object($query);
		return $result;
	} 
    ...
    public function read($id, $parseQuestionList = true)
    {
        ...
        if ($object = Database::fetch_object($result)) {
            ...
            $this->q_topic = $object->topic;
            $this->q_id = $object->e_id;
    ...
    /**
     * returns the exercise Topic.
     *
     * @author Olivier Brouckaert
     *
     *
     * @return string - exercise Topic
     */
    ...
    /**
     * returns the exercise question id.
     *
     * @author Olivier Brouckaert
     *
     *
     * @return string - exercise question id
     */
     ...
     * @author Olivier Brouckaert
     *
     * @param string $title - exercise topic
    */ 
    public function updateExerciseTopic($e_topic)
    {
        $this->q_topic = $e_topic;
    }
	/**
     * changes the exercise title.
     *
     * @author Olivier Brouckaert
     *
     * @param string $title - exercise id
    */ 
    public function updateExerciseId($e_id)
    {
        $this->q_id = $e_id;
    }
    /**
    ...
    public function createForm($form, $type = 'full')
    {
		...
		$form->addElement('text', 'question_topic', [get_lang('Topic'), null, ''], ['id' => 'question_topic']);
		$form->addElement('text', 'question_text_id', [get_lang('Id'), null, ''], ['id' => 'question_text_id']);	
        $editor_config = [
        ...
        if ($type == 'full') {
            if ($this->id > 0) {
				...
				$defaults['question_topic'] = $this->selectTopic();
				$defaults['question_text_id'] = $this->selectQuestionId();
    ...
    public function processCreation($form, $type = '')
    {
        ...
        $this->updateExerciseTopic($form->getSubmitValue('question_topic'));
        $this->updateExerciseId($form->getSubmitValue('question_text_id'));
