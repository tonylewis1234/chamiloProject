...
if (!$inATest) {
    ...
    echo '
        <div class="row hidden-xs">
            <div class="col-sm-4"><strong>'.get_lang('Questions').'</strong></div>
			<div class="col-sm-1 text-center"><strong>'.get_lang('Topic').'</strong></div>
    ...
    if ($nbrQuestions) {
        ...
        if (is_array($questionList)) {
            foreach ($questionList as $id) {
				...
				//test question topic 
				if(!empty($objExercise->q_topic)){
					$questionTopic = $objExercise->q_topic;
				}else
				{
					$questionTopic = '-';
				}
				...
				//echo "<pre>";print_r($objExercise);die;	
                echo '
                    <div id="question_id_list_'.$id.'">
                        <div class="header_operations" data-exercise="'.$objExercise->selectId().'"
                            data-question="'.$id.'">
                            <div class="row">
                                <div class="question col-sm-4 col-xs-12">'
                                    .$questionName.'
                                </div>
								<div class="type text-center col-sm-1 col-xs-12" title="'.$questionTopic.'">
                                    <span class="visible-xs-inline">'.get_lang('Topic').' </span>'
                                    .$questionTopic.'
                                </div>
